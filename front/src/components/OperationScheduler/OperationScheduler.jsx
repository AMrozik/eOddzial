...
// METHODS
    ...
    //     console.log(days);
        ...
        for(i=0; i < alldays/7; i++){
            rows.push(
                <tr>
                <td style={{"backgroundColor": decideColor(0+(i*7), thismonthdays, predays), "border": "2px black solid"}}><a href="/schedule">{days[0+(i*7)]}</a></td>
                <td style={{"backgroundColor": decideColor(1+(i*7), thismonthdays, predays), "border": "2px black solid"}}><a href="/schedule">{days[1+(i*7)]}</a></td>
                <td style={{"backgroundColor": decideColor(2+(i*7), thismonthdays, predays), "border": "2px black solid"}}><a href="/schedule">{days[2+(i*7)]}</a></td>
                <td style={{"backgroundColor": decideColor(3+(i*7), thismonthdays, predays), "border": "2px black solid"}}><a href="/schedule">{days[3+(i*7)]}</a></td>
                <td style={{"backgroundColor": decideColor(4+(i*7), thismonthdays, predays), "border": "2px black solid"}}><a href="/schedule">{days[4+(i*7)]}</a></td>
                <td style={{"backgroundColor": decideColor(5+(i*7), thismonthdays, predays), "border": "2px black solid"}}><a href="/schedule">{days[5+(i*7)]}</a></td>
                <td style={{"backgroundColor": decideColor(6+(i*7), thismonthdays, predays), "border": "2px black solid"}}><a href="/schedule">{days[6+(i*7)]}</a></td>
                </tr>
            );
        }
        return (
    ...
    return (
        <div>
            ...
            <button type="submit">
                <a href={'/schedule/' +yearToShow+'-'+monthToShow}>Przejdz</a>
            </button>
            <table>
